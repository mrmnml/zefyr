...
class ZefyrButton extends StatelessWidget {
  ...
  Color _getColor(ZefyrScope editor, ToolbarTheme theme) {
    if (isAttributeAction) {
      ...
      final isToggled = (attribute is NotusAttribute) ? editor.selectionStyle.containsSame(attribute) : editor.selectionStyle.contains(attribute);
        ...
        children: <Widget>[
          Container(
            ...
            child: Text(
              ...
              style: theme.textTheme.subtitle1.copyWith(color: toolbarTheme.disabledIconColor),
            ),
          )
        ],
      ),
